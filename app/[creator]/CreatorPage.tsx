    ...
    <div className="fixed inset-0 z-[100] bg-black flex items-center justify-center px-6">
      <div className="max-w-sm w-full text-center">
        ...
        <p className="text-gray-400 text-sm mb-8 leading-relaxed">
          This page contains links to adult content. By continuing, you confirm that you are at least <strong className="text-white">18 years old</strong> (or the age of majority in your jurisdiction).
        </p>
        <button
          onClick={onConfirm}
